    ...
    with open(csv_path, "r", newline="") as f:
        ...
        for row in reader:
            cases.append({
                ...
                "iterBatchL1": int(row["iterBatchL1"]),
                "iterBatchL0": int(row["iterBatchL0"]),
                "bias": int(row["bias"]),
...
def run_case(case):
    ...
    batch_a = case["batchA"]
    batch_b = case["batchB"]
    iter_l1 = case["iterBatchL1"]
    iter_l0 = case["iterBatchL0"]
    ...
    if not exec_path:
        exec_path = os.path.join(BUILD_DIR, "mat_mul", "mat_mul_iterbatch_broadcast", "mat_mul_iterbatch_broadcast")
...
def main():
    ...
    for i, case in enumerate(cases, 1):
        ...
        print(f"  Shape: {case['m']} x {case['k']} x {case['n']}, "
              ...
              f"iterL1={case['iterBatchL1']}, iterL0={case['iterBatchL0']}, "
              f"dtype={case['dtype']}")
