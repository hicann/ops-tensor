...
declare -A EXAMPLE_TA EXAMPLE_TB EXAMPLE_DTYPE EXAMPLE_HF32 EXAMPLE_BIAS

EXAMPLE_M[mat_mul_bmm_broadcast]=64
EXAMPLE_K[mat_mul_bmm_broadcast]=128
EXAMPLE_N[mat_mul_bmm_broadcast]=64
EXAMPLE_BATCH[mat_mul_bmm_broadcast]=4
EXAMPLE_BA[mat_mul_bmm_broadcast]=1
EXAMPLE_BB[mat_mul_bmm_broadcast]=4
EXAMPLE_TA[mat_mul_bmm_broadcast]=false
EXAMPLE_TB[mat_mul_bmm_broadcast]=false
EXAMPLE_DTYPE[mat_mul_bmm_broadcast]=float16
EXAMPLE_HF32[mat_mul_bmm_broadcast]=false
EXAMPLE_BIAS[mat_mul_bmm_broadcast]=0

TARGET=""
CASE_FILE=""
SKIP_BUILD=false
BUILD_ONLY=false
M="" K="" N="" BATCH="" BA="" BB="" TRANS_A="" TRANS_B="" DTYPE="" IS_HF32="" BIAS=""
...
do_build() {
    local target="${EXAMPLE:-${TARGET:-mat_mul_bmm_broadcast}}"
...
run_csv_cases() {
    ...
    local target="${TARGET:-mat_mul_bmm_broadcast}"
...
main() {
    echo "=========================================="
    echo "  mat_mul_bmm_broadcast One-Click Runner"
    echo "=========================================="
    preflight
    if [[ -n "$CASE_FILE" ]]; then
