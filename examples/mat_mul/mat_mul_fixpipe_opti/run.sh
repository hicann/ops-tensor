...
EXAMPLE_M[mat_mul_fixpipe_opti]=512
EXAMPLE_K[mat_mul_fixpipe_opti]=256
EXAMPLE_N[mat_mul_fixpipe_opti]=64
EXAMPLE_TA[mat_mul_fixpipe_opti]=false
EXAMPLE_TB[mat_mul_fixpipe_opti]=false
EXAMPLE_DTYPE[mat_mul_fixpipe_opti]=float16
EXAMPLE_HF32[mat_mul_fixpipe_opti]=false
EXAMPLE_BIAS[mat_mul_fixpipe_opti]=0
EXAMPLE_FORMAT[mat_mul_fixpipe_opti]="(ND,ND)"
...
do_build() {
    local target="${EXAMPLE:-${TARGET:-mat_mul_fixpipe_opti}}"
...
run_csv_cases() {
    ...
    local target="${TARGET:-mat_mul_fixpipe_opti}"
...
main() {
    echo "=========================================="
    echo "  mat_mul_fixpipe_opti One-Click Runner"
