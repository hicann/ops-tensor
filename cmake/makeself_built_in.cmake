...
# ----------------------------------------------------------------------------
# makeself_built_in.cmake - ops-tensor 内置自解压打包脚本
...
execute_process(
    COMMAND python3 ${CPACK_CMAKE_SOURCE_DIR}/scripts/package/package.py --pkg_name ops_tensor --chip_name ${CPACK_SOC} --os_arch linux-${CPACK_ARCH}
...
set(OPS_TENSOR_VERSION_OUT_PUT ${CPACK_CMAKE_BINARY_DIR}/version.ops_tensor.info)
set(OPS_TENSOR_VERSION_H ${CPACK_CMAKE_BINARY_DIR}/ops_tensor_version.h)

if(EXISTS ${SCENE_OUT_PUT})
    configure_file(
        ${SCENE_OUT_PUT}
        ${STAGING_DIR}/share/info/ops_tensor/
        COPYONLY
    )
endif()
...
if(EXISTS ${CSV_OUTPUT})
    configure_file(
        ${CSV_OUTPUT}
        ${STAGING_DIR}/share/info/ops_tensor/script/
        COPYONLY
    )
endif()

if(EXISTS ${OPS_TENSOR_VERSION_OUT_PUT})
    configure_file(
        ${OPS_TENSOR_VERSION_OUT_PUT}
        ${STAGING_DIR}/share/info/ops_tensor/
        COPYONLY
    )
endif()

if(EXISTS ${OPS_TENSOR_VERSION_H})
    configure_file(
        ${OPS_TENSOR_VERSION_H}
        ${STAGING_DIR}/share/info/ops_tensor/
        COPYONLY
    )
endif()
...
execute_process(
    COMMAND bash ${MAKESELF_EXE}
        ...
        --help-header share/info/ops_tensor/script/help.info
        ${makeself_param_string} share/info/ops_tensor/script/install.sh
