...
public:
        ...
        bool dbL0C)
    {
        ...
        aL1OneBuffer_ = (baseM_ * Cmct::Gemm::Align(kL1_, MXFP_DIVISOR_SIZE)) >> sizeShift;
        ...
        TensorBias const& gmBias, TensorC const& gmC, BlockShape const& singleShape)
    {
        ...
        for (uint64_t iter0 = 0; iter0 < kL1Iter_; ++iter0) {
            ...
            tensorAL1 = AscendC::Te::MakeTensor(AscendC::Te::MakeL1memPtr<AType>(l1BufferAOffset_[l1BufId]), layoutAL1);
            ...
            auto layoutScaleAL1 = AscendC::Te::MakeZzLayout<fp8_e8m0_t>(
                tileL1L0Param.curM, Cmct::Gemm::CeilDiv(scaleKL1_, MXFP_DIVISOR_SIZE) * 2);
