...
#warning "impl/tensor_api/arch/datamove/l1_to_ub/copy.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
...
* \brief
*/
#ifndef IMPL_TENSOR_API_ARCH_DATAMOVE_L1_TO_UB_COPY_H
#define IMPL_TENSOR_API_ARCH_DATAMOVE_L1_TO_UB_COPY_H

#include "impl/tensor_api/utils/utils_impl.h"
#include "impl/tensor_api/atom/copy_traits_impl.h"
#include "impl/tensor_api/arch/datamove/l1_to_ub/routing.h"
...
#endif // IMPL_TENSOR_API_ARCH_DATAMOVE_L1_TO_UB_COPY_H
