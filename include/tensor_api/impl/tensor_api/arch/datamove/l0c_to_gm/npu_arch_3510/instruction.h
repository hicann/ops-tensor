...
#warning                                                                                                               \
    "impl/tensor_api/arch/datamove/l0c_to_gm/npu_arch_3510/instruction.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_DATAMOVE_L0C_TO_GM_NPU_ARCH_3510_INSTRUCTION_H
#define IMPL_TENSOR_API_ARCH_DATAMOVE_L0C_TO_GM_NPU_ARCH_3510_INSTRUCTION_H
...
#endif // IMPL_TENSOR_API_ARCH_DATAMOVE_L0C_TO_GM_NPU_ARCH_3510_INSTRUCTION_H
