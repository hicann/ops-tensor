...
#warning                                                                                                               \
    "impl/tensor_api/arch/datamove/l1_to_l0b/npu_arch_3510/nz2znb8b4_with_coord.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_DATAMOVE_L1_TO_L0B_NPU_ARCH_3510_NZ2ZNB8B4_WITH_COORD_H
#define IMPL_TENSOR_API_ARCH_DATAMOVE_L1_TO_L0B_NPU_ARCH_3510_NZ2ZNB8B4_WITH_COORD_H

#include "impl/tensor_api/arch/datamove/l1_to_l0b/npu_arch_3510/instruction.h"

namespace AscendC {
namespace Te {
class LoadDataL12L0BNZ2ZNB8B4WithCoord3510 {
...
private:
    ...
    __aicore__ inline static void LoadDataImpl(const T& dst, const U& src, const Coord& coord)
    {
        ...
        auto mStep = GetElement<AttrInfo::Shape, AttrInfo::Row, 1>(srcLayout) *
                GetElement<AttrInfo::Shape, AttrInfo::Row, 0>(srcLayout) / FRACTAL_FIXED - mStartPosition;
...
#endif // IMPL_TENSOR_API_ARCH_DATAMOVE_L1_TO_L0B_NPU_ARCH_3510_NZ2ZNB8B4_WITH_COORD_H
