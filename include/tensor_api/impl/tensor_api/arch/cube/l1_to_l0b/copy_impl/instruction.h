...
public:
    ...
    {
        LoadCbufToCbImpl<transpose>(dst.Data().Get(), src.Data().Get(), params...);
    }

private:
    template <bool transpose, typename T>
    __aicore__ inline static void LoadCbufToCbImpl(__cb__ T* dst, __cbuf__ T* src, uint16_t mStartPosition,
