 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_CUBE_L1_TO_L0A_COPY_IMPL_NZ2NZ_WITH_COORD_H
#define IMPL_TENSOR_API_ARCH_CUBE_L1_TO_L0A_COPY_IMPL_NZ2NZ_WITH_COORD_H

#include "impl/tensor_api/arch/cube/l1_to_l0a/copy_impl/instruction.h"

namespace AscendC {
namespace Te {
class LoadDataL12L0ANZ2NZWithCoord {
...
private:
    ...
    __aicore__ inline static void LoadDataImpl(const T& dst, const U& src, const Coord& coord)
    {
        ...
        if constexpr (IsB4Type<DstType>) {
            LoadCbufToCa::LoadData<false>(dst, src, mStartPosition, kStartPosition / KHALF, mStep, kStep, srcStride, dstStride);
        } else {
...
#endif // IMPL_TENSOR_API_ARCH_CUBE_L1_TO_L0A_COPY_IMPL_NZ2NZ_WITH_COORD_H
